# ArchFlow Codebase Encyclopedia
...
└── ARCHFLOW_TODO.md            # Issues and roadmap
```
...
The ArchFlow application is a Progressive Web App (PWA) built with RSBuild that provides a complete diagram editor interface using the fossflow-lib library.
...
ArchFlow supports multiple languages using react-i18next with automatic language detection.
...
1. **Clone and Install**:
```bash
git clone https://github.com/stan-smith/ArchFlow
cd ArchFlow
...
This encyclopedia serves as a comprehensive guide to the ArchFlow codebase. Use the table of contents and quick references to efficiently navigate to the areas you need to modify or understand.

**For Contributors**: See [CONTRIBUTORS.md](./CONTRIBUTORS.md) for contribution guidelines and [ARCHFLOW_TODO.md](./ARCHFLOW_TODO.md) for current issues and roadmap.
